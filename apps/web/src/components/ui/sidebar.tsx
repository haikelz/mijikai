...
function SidebarInput({
  ...
  return (
    <Input
      ...
      data-sidebar="input"
      className={tw("bg-background h-8 w-full shadow-none", className)}
      {...props}
    />
  );
}
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={tw("bg-sidebar-border mx-2 w-auto", className)}
      {...props}
    />
  );
}
...
function SidebarMenuSubItem({
  ...
  return (
    <li
      ...
      className={tw("group/menu-sub-item relative", className)}
      {...props}
    />
  );
}
